...
#define ROTR(x, b) (((x) >> (b)) | ((x) << (64-(b))))
    ...
    void keccak_state::round(uint64_t rc)
    {
        ...
        // B[0][0] = A[0][0]
        B[2][0] = ROTL(A[0][1], 1);
        B[4][0] = ROTR(A[0][2], 64-62);
        B[1][0] = ROTL(A[0][3], 28);
        B[3][0] = ROTL(A[0][4], 27);
        B[3][1] = ROTR(A[1][0], 64-36);
        B[0][1] = ROTR(A[1][1], 64-44);
        B[2][1] = ROTL(A[1][2], 6);
        B[4][1] = ROTR(A[1][3], 64-55);
        B[1][1] = ROTL(A[1][4], 20);
        B[1][2] = ROTL(A[2][0], 3);
        B[3][2] = ROTL(A[2][1], 10);
        B[0][2] = ROTR(A[2][2], 64-43);
        B[2][2] = ROTL(A[2][3], 25);
        B[4][2] = ROTR(A[2][4], 64-39);
        B[4][3] = ROTR(A[3][0], 64-41);
        B[1][3] = ROTR(A[3][1], 64-45);
        B[3][3] = ROTL(A[3][2], 15);
        B[0][3] = ROTL(A[3][3], 21);
        B[2][3] = ROTL(A[3][4], 8);
        B[2][4] = ROTL(A[4][0], 18);
        B[4][4] = ROTL(A[4][1], 2);
        B[1][4] = ROTR(A[4][2], 64-61);
        B[3][4] = ROTR(A[4][3], 64-56);
        B[0][4] = ROTL(A[4][4], 14);

        // chi
        A[0][1] = B[0][1] ^ (~B[0][2] & B[0][3]);
        A[0][2] = B[0][2] ^ (~B[0][3] & B[0][4]);
        A[0][3] = B[0][3] ^ (~B[0][4] & A[0][0]); // ! A
        A[0][4] = B[0][4] ^ (~A[0][0] & B[0][1]); // ! A
